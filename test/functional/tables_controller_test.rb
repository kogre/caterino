...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { capacity: @table.capacity, h: @table.h, tid: @table.tid, w: @table.w, x: @table.x, y: @table.y }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { capacity: @table.capacity, h: @table.h, tid: @table.tid, w: @table.w, x: @table.x, y: @table.y }
    assert_redirected_to table_path(assigns(:table))
  end
